...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'create_goal', 'edit', 'exit_plan_mode', 'get_goal', 'glob', 'grep', 'history_read',
      ...
      'session_event_trace', 'session_search', 'session_trace', 'show_task_surface', 'skill', 'spawn_teammate',
