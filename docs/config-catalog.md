...
- `@deepseek-ai/dsh-experimental-tool-task-surface` — requires `tools` ([`packages/experimental/tool-task-surface/src/index.ts`](../packages/experimental/tool-task-surface/src/index.ts))
