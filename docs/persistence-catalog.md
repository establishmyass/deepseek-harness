...
Source: [`packages/experimental/tool-task-surface/src/projection.ts:43`](../packages/experimental/tool-task-surface/src/projection.ts)
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:task-surface/dismissed.data`](#persistence-type-eventtask-surfacedismisseddata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"task-surface/dismissed"` |
...
Sources: [`packages/experimental/tool-task-surface/src/projection.ts:43`](../packages/experimental/tool-task-surface/src/projection.ts)
